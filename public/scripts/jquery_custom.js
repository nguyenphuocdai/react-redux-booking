  ...
  $(document).ready(function() {
    ...
    $trigger.on("click", function(e) {
      ...
      if (
        ...
        $(this)
          .find("span")
          .addClass("ui-accordion-icon-active");
        $(this)
    ...
    $accor.each(function() {
      ...
      $(this)
        .find("div")
        .addClass(
          "ui-accordion-content ui-helper-reset ui-utf_widget_content ui-corner-bottom"
        );
      $(this)
        .find("div")
        .hide();
    ...
    $(window).on("load resize", function() {
      ...
      var winWidth = $(window).width();
      if (winWidth > 992) {
        $(".utf_dashboard_navigation_inner_block").css(
          "max-height",
          main_wrapperHeight - headerHeight
        );
      } else {
    ...
    function newMenuItem() {
      var newElem = $("tr.pricing-list-item.pattern")
        .first()
        .clone();
    ...
    $('input[type="range"].distance-radius').rangeslider({
      polyfill: false,
      onInit: function() {
        this.output = $('<div class="utf_range_output" />')
    ...
    $(".listing-nav-container")
      ...
      .addClass("cloned")
      .prependTo("body");
    $(".listing-nav a, a.listing-address, .utf_star_rating_section a").on(
      "click",
      function(e) {
        e.preventDefault();
    ...
    $(
      ".listing-nav li:first-child a, a.utf_add_review-btn, a[href='#utf_add_review']"
    ).on("click", function(e) {
      e.preventDefault();
      $("html,body").scrollTo(this.hash, this.hash, {
        gap: {
